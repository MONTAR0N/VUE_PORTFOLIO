  ...
  <div class="main-container">
    ...
    <div class="social-links">
      <a href="https://github.com/MONTAR0N">
        <div class="link-div">
          <img src="../assets/github-logo-icon.png" alt="" class="logo-img" />
          <h3>Github</h3>
        </div>
      </a>
      <a href="https://www.linkedin.com/in/vicente-avil%C3%A9s-93a63b171/">
        <div class="link-div">
          <img src="../assets/icons8-linkedin-48.png" alt="" class="logo-img" />
          <h3>LinkedIn</h3>
        </div>
      </a>
      <a href="mailto:vavilesb1@gmail.com">
        <div class="link-div">
          <img src="../assets/gmail-logo-4-1.png" alt="" class="logo-img" />
          <h3>Gmail</h3>
        </div>
      </a>
      <a href="https://wa.me/56977556547">
        <div class="link-div">
          <img src="../assets/whatsapp-logo-4-1.png" alt="" class="logo-img" />
          <h3>WhatsApp</h3>
        </div>
      </a>
    </div>
    <div class="about">
      ...
      <p style="text-align: center;">
        ...
        delectus blanditiis reiciendis error veritatis suscipit consequatur eius
        autem aut necessitatibus corporis velit, facilis enim obcaecati.
        Voluptatem accusamus totam corporis.
      </p>
    </div>
